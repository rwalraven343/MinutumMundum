...
static const SOLID_OCTAGON_OBJECT_PROPERTIES ball_solid_octagon_object_properties={{128,1024,4096,0.25,8,4,0.25,8},{256,512,2,8,16,1024,-8,8,256,0.25,0.25,1.25},128};

class BALL_OBJECT : public SOLID_OCTAGON_OBJECT, public FEATURE/*, public BEAM_OBJECT<SOLID_OCTAGON_OBJECT>*/
{
  ...
  public:
	...
	BALL_OBJECT()
	{
		SOLID_OCTAGON_OBJECT::init_reset(ball_solid_octagon_object_properties);
	...
	void light() const
	{
		if (!SOLID_OCTAGON_OBJECT::hasvapourized())
		{
			...
			VIDEO::DYNAMIC_LIGHTING::draw_pointlight(pos.x,pos.y,0,1,0,1,512);
