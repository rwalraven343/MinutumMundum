...
static const SOLID_OBJECT_PROPERTIES enemy_spaceship_solid_object_properties={{256,384,1024,4096,0.25,0.25,0.25,0.25,8},{256,384,2,8,16,1024,-8,8,256,0.25,0.25,1.25},4};

class ENEMY_SPACESHIP_OBJECT : public BIG_SOLID_OBJECT, public FEATURE/*, public BEAM_OBJECT<BIG_SOLID_OBJECT>*/
{
  ...
  public:
	...
	ENEMY_SPACESHIP_OBJECT()
	{
		BIG_SOLID_OBJECT::init_reset(enemy_spaceship_solid_object_properties);
